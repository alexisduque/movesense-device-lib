...
uint8_t s_customScanRespAvertiseData[] =
{
    // Block: Data size and type
    0x23,0x09,
    // Data here is one uint16_t for CompanyID, and one uint16_t for data payload.
    0x4C, 0x49, 0x42, 0x4D, 0x20, 0x4D, 0x6F, 0x76, 0x65, 0x73, 0x65, 0x6E, 0x73, 0x65, 0x20, 0x48
};
...
bool CustomBLEAdv::startModule()
{
    ...
    advSettings.scanRespPacket = wb::MakeArray<uint8>(s_customScanRespAvertiseData, sizeof(s_customScanRespAvertiseData));
